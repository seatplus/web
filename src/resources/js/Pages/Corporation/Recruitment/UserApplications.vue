<template>
  <div class="space-y-4">
    <div
      v-for="application in user_applications"
    ...
    >
        ...
        <div class="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
            ...
            <div class="flex items-center">
              <div>
                <EveImage
                  ...
                  :size="256"
                  :object="application.main_character"
                />
              </div>
              <div class="ml-3">
          ...
          <div class="ml-4 mt-2 flex-shrink-0 flex">
            ...
            <span class="ml-3 inline-flex rounded-md shadow-sm">
              <inertia-link
                :href="$route('user.application', application.user.id)"
                type="button"
                class="relative inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:ring-indigo active:bg-indigo-700 transition ease-in-out duration-150"
              >
                Handle Application
              </inertia-link>
            </span>
      ...
      <ul class="divide-y divide-gray-200">
        <!--Characters-->
        <Applicant
          v-for="applicant in application.characters"
