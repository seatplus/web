...
<!--    <infinite-loading
      spinner="waveDots"
      force-use-infinite-wrapper=".main.flex-1"
        ...
        <template #description>
          <div>
            ...
            <p class="mt-2 text-sm text-gray-500">
              Chose a descriptive name for the group to be created
            </p>
          </div>
        </template>
        <template #buttons>
...
<script>
  ...
  export default {
      ...
      components: {
          ManageMembers, ControlGroups, ModalWithFooter, Layout,
          //InfiniteLoading
      },
      data() {
          return {
