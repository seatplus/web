            ...
            <div class="bg-white overflow-hidden shadow rounded-lg col-span-2">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="mt-6 sm:mt-5">
                        ...
                        <p v-if=this.$page.props.errors.selectedEntities class="text-sm text-red-600">{{this.$page.props.errors.selectedEntities[0]}}</p>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        components: {
            ...
            PageHeader, SearchCorpOrAlliance, EveImage, Alerts, CorporationScopes, CharacterScopes, Layout},
        props: {
            available_scopes: {
                type: Object,
                required: true
