<template>
    <Settings :layout-object="this.layoutObject">
        <ul class="divide-y divide-gray-200">
            <WideListElement v-if="hasGlobalScopes" :url="$route('view.global.scopes')">
                ...
                <template v-slot:upper_left>Global SSO Scopes</template>
            ...
            <li>
                <inertia-link :href="$route('view.create.scopes')" class="block hover:bg-gray-50 focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out">
