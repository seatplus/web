        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            ...
            <div>
              <span class="relative z-0 inline-flex shadow-sm">
                  <inertia-link :disabled="prevDisabled" :href="buildHref(1)"
                                ...
                                :class="{ 'text-gray-500 hover:text-gray-400': !prevDisabled, 'text-gray-400': prevDisabled }">
                  ...
                  <inertia-link  :disabled="nextDisabled" :href="buildHref(collection.meta.current_page + 1)"
                          ...
                          :class="{ 'text-gray-500 hover:text-gray-400': !nextDisabled, 'text-gray-400': nextDisabled}">
                    <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd"
                  ...
                  <inertia-link  :disabled="nextDisabled" :href="buildHref(collection.meta.last_page)"
