<template>
  <Link
    ...
    :class="{'px-2.5 py-1.5 text-xs font-medium' : buttonSize === 'xs', 'px-3 py-2 text-sm leading-4 font-medium' : buttonSize === 'small', 'px-4 py-2 text-sm font-medium' : buttonSize === 'medium', }"
    @click="$emit('click')"
  >
    <slot />
  </Link>
