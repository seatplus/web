<template>
    <div class="relative inline-block text-left z-10"> <!--@keydown.escape="open = false" @click.away="open = false" -->
        <div>
            <span class="rounded-md shadow-sm">
              <button ref="button" @click="toggleDropdown" type="button" class="inline-flex justify-center w-full rounded-md border border-gray-300 px-4 py-2 bg-white text-sm leading-5 font-medium text-gray-700 hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800 transition ease-in-out duration-150">
                Options
        ...
        >
            <div v-show="open" ref="dropdown" class="origin-top-right absolute rotate-0 right-0 mt-2 w-56 rounded-md shadow-lg ">
        ...
        methods: {
            toggleDropdown() {
                ...
                this.$nextTick(() => {
                    ...
                    this.$emit('change', this.open ? this.$refs.dropdown.clientHeight : 0)
                })
