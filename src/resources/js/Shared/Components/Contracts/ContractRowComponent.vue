<template>
    <li @click="openDetails" :class="{'cursor-pointer':contract.items > 0}" class="bg-white grid grid-cols-2 sm:grid-cols-5 sm:gap-1 grid-flow-row hover:bg-gray-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
        <div class="px-6 py-4 sm:py-1 self-center truncate">
            <label class="block text-sm font-medium text-gray-700 sm:hidden">
                Issuer
            </label>
            <EntityByIdBlock
                :image-size="10" name-font-size="sm"
                :id="contract.for_corporation ? contract.issuer_corporation_id : contract.issuer_id"
            />

            <EntityByIdBlock class="ml-6" v-if="contract.for_corporation"
                             :image-size="6" name-font-size="xs"
                             :id="contract.for_corporation ? contract.issuer_corporation_id : contract.issuer_id"
            />
        ...
        <div class="px-6 py-1 self-center truncate">
            ...
            <EntityByIdBlock class="ml-6" v-if="contract.acceptor_id !== 0 && contract.acceptor_id !== contract.assignee_id"
                             :image-size="6" name-font-size="xs"
        ...
        <div class="text-sm font-medium text-gray-500 px-6 sm:py-1 sm:self-center">
            ...
            <p v-if="contract.type !== 'courier'" class="flex items-center text-sm text-gray-500">
        ...
        <div class="text-sm font-medium text-gray-500 px-6 sm:py-1 sm:self-center">
            ...
            <p v-if="contract.reward > 0" class="flex items-center text-sm text-gray-500">
                <svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" />
                </svg>
                Reward {{ contract.reward.toLocaleString() }}
            </p>
            <p v-if="contract.collateral > 0" class="flex items-center text-sm text-gray-500">
                <svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" />
                </svg>
                Collateral {{ contract.collateral.toLocaleString() }}
            </p>
            <p v-if="contract.price > 0" class="flex items-center text-sm text-gray-500">
                <svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" />
                </svg>
            ...
            <p v-if="contract.volume > 0" class="flex items-center text-sm text-gray-500">
                <svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
