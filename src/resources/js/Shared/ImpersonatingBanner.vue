                    ...
                    <div class="flex items-center justify-between flex-wrap">
                        <div class="w-0 flex-1 flex items-center">
                            ...
                            <p class="ml-3 font-medium text-white truncate">
                                <span class="md:hidden">Impersonating {{name}}</span>
                                <span class="hidden md:inline">You experience everything exactly as if you were {{name}}. </span>
                            </p>
                        </div>
                        <div class="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
                            <div class="rounded-md shadow-sm">
                                <inertia-link :href="$route('impersonate.stop')" class="flex items-center justify-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-indigo-600 bg-white hover:text-indigo-500 focus:outline-none focus:shadow-outline transition ease-in-out duration-150">
                                    Stop
                                </inertia-link>
                            </div>
                        </div>
