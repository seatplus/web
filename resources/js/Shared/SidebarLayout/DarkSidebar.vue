            ...
            <nav class="mt-5 flex-1 px-2 bg-gray-800 space-y-3">
              ...
              >
                ...
                <Disclosure
                  ...
                  class="space-y-1"
                >
                  <!--              :class="[category.current ? 'bg-gray-100 text-gray-900' : 'bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900', 'group w-full flex items-center pr-2 py-2 text-left text-sm font-medium rounded-md focus:outline-hidden focus:ring-2 focus:ring-indigo-500']"    -->
                  <DisclosureButton :class="['text-white font-semibold uppercase text-xs hover:text-gray-400', 'group w-full flex items-center pr-2 py-2 text-left text-sm font-medium rounded-md focus:outline-hidden focus:ring-2 focus:ring-indigo-500']">
                    <svg
