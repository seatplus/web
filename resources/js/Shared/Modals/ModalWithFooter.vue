  ...
  <Modal v-model="open">
    ...
    >
      ...
      <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
        ...
        <span
          v-if="cancelButton"
          class="mt-3 flex w-full rounded-md shadow-xs sm:mt-0 sm:w-auto"
        >
          <button
            type="button"
            class="inline-flex justify-center w-full rounded-md border border-gray-300 px-4 py-2 bg-white text-base leading-6 font-medium text-gray-700 shadow-xs hover:text-gray-500 focus:outline-hidden focus:border-blue-300 focus:ring-3 transition ease-in-out duration-150 sm:text-sm sm:leading-5"
            @click="toggle"
          >
            Cancel
          </button>
