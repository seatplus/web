<template>
  <Modal v-model="openModal">
    <div
      v-if="openModal"
      class="bg-white rounded-lg px-4 pt-5 pb-4 max-h-3/4 overflow-hidden shadow-xl transform transition-all sm:max-w-3xl sm:w-full sm:p-6"
      role="dialog"
      aria-modal="true"
            ...
            <div class="w-full flex items-center justify-between p-3 space-x-3">
              <div class="flex-1 truncate">
                ...
                <p class="mt-1 text-gray-500 text-sm leading-5 truncate">
                  {{ character.owned_by_user ? 'owned' : 'affiliated' }}
                </p>
              </div>
              <EveImage
                :object="character"
