  ...
  <RadioGroup v-model="selected">
    ...
    <div class="bg-white rounded-md -space-y-px">
      <RadioGroupOption
        ...
        :value="setting"
      >
        <div :class="[settingIdx === 0 ? 'rounded-tl-md rounded-tr-md' : '', settingIdx === options.length - 1 ? 'rounded-bl-md rounded-br-md' : '', checked ? 'bg-indigo-50 border-indigo-200 z-10' : 'border-gray-200', 'relative border p-4 flex cursor-pointer focus:outline-hidden']">
          <span
