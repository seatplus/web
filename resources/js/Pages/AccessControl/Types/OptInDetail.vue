<template>
  <div class="space-y-6">
    <p class="text-sm text-gray-500">
      Users whose characters belong to the selected corporations or alliances may freely join or leave this role.
    </p>
    ...
    <div>
      <h3 class="text-sm font-medium text-gray-700 mb-2">Eligibility criteria — who may join</h3>
      ...
      <p v-else class="text-sm text-gray-400 italic">No eligibility criteria — no users can join.</p>
    </div>
...
function save(): void {
  form.post(route('acl.update.opt-in', props.role.id))
}
</script>
