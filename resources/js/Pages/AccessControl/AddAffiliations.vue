<template>
  <div class="max-w-md rounded-md relative shadow-sm w-full">
    ...
    <SeatPlusSelect v-model="selected">
      <option
        v-for="entity in availableEntities.characters"
        :key="entity.name"
        :value="entity.character_id"
      >
        {{ entity.name }} (Character)
      </option>
      <option
        v-for="entity in availableEntities.corporations"
        :key="entity.name"
        :value="entity.corporation_id"
      >
        {{ entity.name }} (Corporation)
      </option>
      <option
        v-for="entity in availableEntities.alliances"
        :key="entity.name"
        :value="entity.alliance_id"
      >
