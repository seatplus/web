    ...
    <div>
      <div class="divide-y divide-gray-200">
        ...
        <div class="pt-6">
          ...
          <div class="mt-6">
            <form @submit.prevent="form.put(commentApplication(application.id).url,{ onSuccess: () => form.reset('comment') })">
...
import { application as commentApplication } from '@/routes/comment'
